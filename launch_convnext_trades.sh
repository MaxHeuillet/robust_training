...
HPO_SOURCE_PRNM="full_fine_tuning50"   # where to read HPO yaml configs from
EMAIL="maxime.heuillet.france@ulaval.ca"                            # <-- set your email here
ACCOUNT="mheuill"                          # <-- set your SLURM account here
...
LOSS="${LOSS}",\
PRNM="${PRNM}",\
HPO_SOURCE_PRNM="${HPO_SOURCE_PRNM}",\
EMAIL="${EMAIL}" \
