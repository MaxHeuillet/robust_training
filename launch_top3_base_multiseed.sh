#!/bin/bash
# =============================================================================
# launch_top3_base_multiseed.sh
# Reviewer-response launcher: re-trains the top-3 FFT-50 "Base" leaderboard
...
#
#   Gold   : convnext_base.fb_in22k          + TRADES_v2  (GR:1)
#   Silver : coatnet_2_rw_224.sw_in12k_ft_in1k + TRADES_v2  (GR:2)
#   Bronze : coatnet_2_rw_224.sw_in12k         + TRADES_v2  (GR:3)
#
...
#   convnext_base_fb_in22k_TRADES_v2_seed1
#   convnext_base_fb_in22k_TRADES_v2_seed2
#   convnext_base_fb_in22k_TRADES_v2_seed3
#
# Usage: bash launch_top3_base_multiseed.sh
# =============================================================================
...
CONFIGS=(
  "convnext_base.fb_in22k|TRADES_v2|convnext_base_fb_in22k_TRADES_v2"
  "coatnet_2_rw_224.sw_in12k_ft_in1k|TRADES_v2|coatnet_2_rw_224_sw_in12k_ft_in1k_TRADES_v2"
  "coatnet_2_rw_224.sw_in12k|TRADES_v2|coatnet_2_rw_224_sw_in12k_TRADES_v2"
)
