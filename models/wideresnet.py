...
class WideResNet(nn.Module):
    ...
    def _make_layer(self, block, num_blocks, in_planes, out_planes, stride, dropRate):
        layers = []
...
# Example instantiation for CIFAR-10 with WideResNet-16-8
model = WideResNet(depth=16, widen_factor=8, num_classes=10, dropRate=0.3)
print(model)
