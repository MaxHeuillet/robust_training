...
MANIFESTS = [
    # "batch_manifest__all_datasets__adv_clip_common_severity3.json",
    "batch_manifest__all_datasets__adv_clip_l1_eps75.json",
    "batch_manifest__all_datasets__adv_clip_l1_eps300.json",
    "batch_manifest__all_datasets__adv_clip_l2_eps2.json",
    "batch_manifest__all_datasets__adv_clip_l2_eps8.json",
    "batch_manifest__all_datasets__adv_clip_linf8.json",
    "batch_manifest__all_datasets__adv_linf30.json",
    "batch_manifest__all_datasets__common_severity3.json",
    "batch_manifest__all_datasets__test_v1.json",
]
