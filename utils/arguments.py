...
def get_args():
    ...
    parser.add_argument("--pruning_strategy", default="none", type=str,choices=['none', 'random', 'uncertainty', 'score_v1', 'score_v2', 'TS_pruning'], help="the pruning strategy")
    ...
    parser.add_argument("--step_size", default=0.003, type=float, help="step size of trades")
    parser.add_argument("--perturb_steps", default=10, type=int, help="number of steps of trades")
    parser.add_argument("--beta", default=5.0, type=float, help="beta of trades")
