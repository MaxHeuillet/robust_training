...
def get_args2():
    ...
    parser.add_argument('--dataset', default='dtd', type=str, help='dataset: ' + ' (default: cifar10)')
    parser.add_argument("--loss_function", default="TRADES_v2", type=str, help="the loss function")
    parser.add_argument('--seed', default=0, type=int, help="random seed")
    parser.add_argument("--project_name", default = 'linearprobe_50epochs', type=str, help="task")
