...
#         slurm_tmpdir = os.environ.get(config.cluster_data_path)
...
#         data_dir = os.path.abspath(config.local_data_path)
...
#         statedict_dir = os.path.expanduser(config.cluster_statedict_path) #config.cluster_statedict_path # #TO UPDATE
#         # if hp_opt:
